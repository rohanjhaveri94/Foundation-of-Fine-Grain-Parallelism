/*
 * InputReaderParser.hpp: This file is part of the Parametric Tiling project.
 * 
...
#ifndef PTILE_INPUTREADERPARSER_H
# define PTILE_INPUTREADERPARSER_H
...
public:
  ...
  vector<Expression*>* ParseInput();
};//class InputReaderParser


#endif // !PTILE_INPUTREADERPARSER_H
